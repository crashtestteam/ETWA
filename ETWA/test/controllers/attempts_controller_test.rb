...
class AttemptsControllerTest < ActionController::TestCase
  ...
  test "should create attempt" do
    assert_difference('Attempt.count') do
      post :create, attempt: { end: @attempt.end, registration_date: @attempt.registration_date, result: @attempt.result, start: @attempt.start }
    end
  ...
  test "should update attempt" do
    patch :update, id: @attempt, attempt: { end: @attempt.end, registration_date: @attempt.registration_date, result: @attempt.result, start: @attempt.start }
    assert_redirected_to attempt_path(assigns(:attempt))
  end
