...
class TimetablesControllerTest < ActionController::TestCase
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post :create, timetable: { end: @timetable.end, location: @timetable.location, slots: @timetable.slots, start: @timetable.start }
    end
  ...
  test "should update timetable" do
    patch :update, id: @timetable, timetable: { end: @timetable.end, location: @timetable.location, slots: @timetable.slots, start: @timetable.start }
    assert_redirected_to timetable_path(assigns(:timetable))
  end
