...
class AttemptsControllerTest < ActionController::TestCase
  ...
  test "should create attempt" do
    assert_difference('Attempt.count') do
      post :create, attempt: { end: @attempt.end, registration_date: @attempt.registration_date, result: @attempt.result, start: @attempt.start, timetable_id: @attempt.timetable_id, user_id: @attempt.user_id }
    end
  ...
  test "should update attempt" do
    patch :update, id: @attempt, attempt: { end: @attempt.end, registration_date: @attempt.registration_date, result: @attempt.result, start: @attempt.start, timetable_id: @attempt.timetable_id, user_id: @attempt.user_id }
    assert_redirected_to attempt_path(assigns(:attempt))
  end
